...
| **选区朗读** | 选中文本后一键朗读（Web Speech API） | 无 |
| **相对路径链接跳转** | 点击 `[链接](./other.md)` 直接跳转到对应文件 | 只能在新窗口中打开 |
| **免费开源** | MIT 协议 | 付费软件 |
